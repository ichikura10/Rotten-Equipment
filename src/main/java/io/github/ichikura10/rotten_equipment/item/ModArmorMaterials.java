...
public enum ModArmorMaterials implements ArmorMaterial {
    ROT_ITEM("rot_item", 26, new int[]{ 5, 7, 5, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_LEATHER, 1f, 0f, () -> Ingredient.of(ModItems.ROTTEN_ITEM.get()));
    ...
    public String getName() {
        return RottenEquipment.MOD_ID + ":" + this.name;
    }
