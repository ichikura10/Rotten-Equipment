...
public class RotMachineRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<RotMachineRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(RottenEquipment.MOD_ID, "rot_machine");

        @Override
        public RotMachineRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
        ...
        @Override
        public @Nullable RotMachineRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, RotMachineRecipe pRecipe) {
